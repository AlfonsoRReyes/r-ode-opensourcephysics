...
public class KeplerApp extends AbstractSimulation implements PropertyChangeListener  {
  ...
  public void initialize() {
    ...
    if(odeSolver==null){
      ...
      control.println("RK4, Adams4, Adams5, Adams6, Butcher5");
    ...
    particle.odeSolver.initialize(control.getDouble("dt"));
...
//    control.setValue("ODE Solver", "CashKarp45");
  ...
  public static void main(String[] args) {
    SimulationControl.createApp(new KeplerApp(), args);
  }
