...
// TODO: may be better to split it onto RightHand- & Jacobian- preparation methods (y/n)?
         ...
         * @return numEqn the count of equations
         */
     ...
     * @param laeSolver the real algebraic equations systems solver, that will be used for
     * solving inner real algebraic equations system.
     */
    private void initialize(LAESolverLU laeSolver){
        this.laeSolver = laeSolver;
        laeSolver.assignEquation(innerLinearAlgebraicEquation);
     ...
     * @param bestConvergenceRequired best convergence required. true value is
...
// TODO: may be isn't necessary:
    ...
    protected double estimateIncrementNorm(double [][] dataArray){
        ...
        return Math.sqrt(incrementNorm / (double)(3*numEqn));
    }
